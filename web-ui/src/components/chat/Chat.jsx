        ...
        <>
            ...
            <div className="main full-width full-height chat-container">
                <div className="content-wrapper mg-2">
                    ...
                    <CustomPlayer id="video-player-1" url={config.PLAYBACK_URL_1} />
                    <CustomPlayer id="video-player-2" url={config.PLAYBACK_URL_2} />
                    <div className="col-wrapper">
                        <div className="chat-wrapper pos-absolute pd-t-1 top-0 bottom-0">
                            ...
                            <div className="composer">
                                <input ref={chatRef} className={`rounded ${!username ? "hidden" : ""}`} type="text" placeholder="Say something" value={message} maxLength={510} onChange={handleChange} onKeyDown={handleKeyDown} />
                                {!username && (
                                    <fieldset>
